...
import com.kedacom.middleware.mt.response.PipSwitchResponse;
 ...
 * 画面切换
 * @author LiPengJia
 * @see PipSwitchResponse
 */
public class PipSwitchRequest extends MTRequest {
	...
	public String toJson() throws JSONException {
		//Req部分
		JSONObject req = super.buildReq("pipswitch");
