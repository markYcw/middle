...
import com.kedacom.middleware.mcu.response.PauseRecResponse;
 ...
 * 暂停录像
 * 
 * @see PauseRecResponse
 * @author YueZhipeng
 * 
 */
public class PauseRecRequest extends McuRequest {
	...
	public String toJson() throws JSONException {
		...
		//Req部分
		JSONObject req = super.buildReq("pauserec");
