...
public class MyImage implements Icon, Serializable {
    ...
    /**
     * Creates an MyImage from the specified file. The image will be preloaded
     ...
     *
     * <pre>
     * new MyImage(&quot;images/myImage.gif&quot;)
     * </pre>
     * <p>
    ...
    /**
     * Creates an MyImage from the specified URL. The image will be preloaded by
    ...
    /**
     * Creates an MyImage from the image.
     *
    ...
    /**
     * Creates an MyImage from an image object. If the image has a "comment"
    ...
    /**
     * Creates an MyImage from an array of bytes which were read from an image
     ...
     *
     * @return the <code>Image</code> object for this <code>MyImage</code>
     */
    ...
    /**
     * Sets the image observer for the image. Set this property if the MyImage
    ...
    private AccessibleMyImage accessibleContext = null;

    /**
     * Gets the AccessibleContext associated with this MyImage. For image icons,
     * the AccessibleContext takes the form of an AccessibleMyImage. A new
     * AccessibleMyImage instance is created if necessary.
     *
     * @return an AccessibleMyImage that serves as the AccessibleContext of this
     * MyImage
    ...
    public AccessibleContext getAccessibleContext() {
        if (accessibleContext == null) {
            accessibleContext = new AccessibleMyImage();
        }
        return accessibleContext;
    }

    /**
     * This class implements accessibility support for the <code>MyImage</code>
     ...
     * @since 1.3
     */
    protected class AccessibleMyImage extends AccessibleContext implements
        ...
        public void setAccessibleIconDescription(String description) {
            MyImage.this.setDescription(description);
        }
    ...
    private void readObject(ObjectInputStream s) throws ClassNotFoundException,
        ...
        width = s.readInt();
        height = s.readInt();
        byte[] byteArray = (byte[]) s.readObject();
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        big.drawImage(getImage(), 0, 0, Color.WHITE, null);
